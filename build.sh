...
glslangValidator -V $ROOT/src/render/shaders/terrain.vert -o $ROOT/build/data/shaders/terrain.vert.spv
glslangValidator -V $ROOT/src/render/shaders/terrain.frag -o $ROOT/build/data/shaders/terrain.frag.spv
